...
const StickerOneIcon = ({ color, class: cs }: IconType) => {
  return (
    <svg
      width="65"
      height="65"
    ...
    >
      <g clipPath="url(#clip0_0_77)">
        ...
        <g filter="url(#filter0_d_0_77)">
          <path
            d="M8 19C8 15.6863 10.6863 13 14 13H51C54.3137 13 57 15.6863 57 19V78H8V19Z"
            fill="white"
          />
